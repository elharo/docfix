...
public class FileParserTest {
     ...
     * combining Javadoc comments into single strings while keeping other lines separate.
     */
    @Test
    public void testParseComplexNumberFile() throws IOException {
        ...
        for (String line : result) {
            if (line.trim().startsWith("/**") && line.contains("Represents a complex number")) {
                ...
                assertTrue("Class Javadoc should contain description", line.contains("arithmetic operations"));
                break;
            }
        }
    ...
    public void testJavadocContentPreservation() throws IOException {
        ...
        for (String line : result) {
            if (line.contains("Constructs a complex number with the specified real and imaginary parts")) {
