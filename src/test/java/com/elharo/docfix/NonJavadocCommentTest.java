 ...
 * unchanged.
 * This test exposes a bug where single-line comments are incorrectly moved.
 */
public class NonJavadocCommentTest {
        ...
        public void testSingleLineCommentsNotMoved() {
                ...
                assertTrue("Single-line comment should stay on same line",
                ...
                assertFalse("Comment should not be moved to separate line",
        ...
        public void testBlockCommentsNotModified() {
                ...
                assertTrue("Block comment should not be modified",
        ...
        public void testConsumeDynamicBugCase() {
                ...
                assertTrue("First comment should stay inline",
                                fixed.contains("buf.getChar(); // u2 bootstrap_method_attr_index;"));
                assertTrue("Second comment should stay inline",
                                fixed.contains("buf.getChar(); // u2 name_and_type_index;"));
                ...
                assertFalse("Comments should not be moved to separate lines (bug pattern 1)",
                                fixed.contains(buggyPattern1));
                assertFalse("Comments should not be moved to separate lines (bug pattern 2)",
